...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\linewidth]{Untitled diagram _ Mermaid Chart-2025-08-22-100758.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-020832.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-025458.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-030128.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-030547.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-031010.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.3\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-031424.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-031748.png}
    \caption{Quy trình tạo hoặc kích hoạt pha protected left động}
...
Để tránh việc duy trì pha protected left quá lâu, hệ thống APC sử dụng bộ nhớ trạng thái bị blocked và deadline bảo vệ như sau:

\begin{lstlisting}[style=py,caption={Cơ chế lưu trạng thái blocked và đặt guard deadline}]
self.blocked_left_memory[lane_id] = min(self.blocked_left_memory.get(lane_id, 0) + 1, 100)
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.3\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-032039.png}
    \caption{Cơ chế bộ nhớ và guard deadline cho pha rẽ trái bảo vệ}
...
Thời lượng pha protected left được tính toán tối ưu dựa trên độ dài hàng chờ, thời gian chờ, trạng thái downstream và tham số max\_green:

\begin{lstlisting}[style=py,caption={Tối ưu hóa thời lượng pha protected left}]
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.7\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-032611.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-032828.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-033117.png}
    \caption{Quy trình phát hiện và xử lý mất cân bằng lưu lượng (emergency rebalancing khi xảy ra lane imbalance)}
    \label{fig:emergency_rebalance_flow}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-033310.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{Untitled diagram _ Mermaid Chart-2025-08-29-033500.png}
    \caption{Quy trình cooldown để ngăn chặn hiện tượng flicker pha}
    \label{fig:cooldown_flicker_diagram}
\end{figure}