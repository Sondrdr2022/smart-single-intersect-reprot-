...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\textwidth]{Untitled diagram _ Mermaid Chart-2025-09-03-012153.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Untitled diagram _ Mermaid Chart-2025-09-03-012659.png}
    \caption{Quy trình lưu trữ và đồng bộ Q-Table cùng trạng thái hệ thống}
    \label{fig:qtable_sync_diagram}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{Untitled diagram _ Mermaid Chart-2025-09-03-013137.png}
